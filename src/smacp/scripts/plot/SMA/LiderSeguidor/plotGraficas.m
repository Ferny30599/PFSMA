...
plot(trayx,trayy,'LineWidth',4,'Color', [0.2, 0.7, 0.1]);
...
legend('RMD1','RMD2','RMD3','RMD4','RMD5','RMD6','Trayectoria','Location', 'southwest')
...
plot3(posx6,posy6,tiempo1,'LineWidth',4,'Color', [0.2, 0.7, 0.7]);
plot3(trayx,trayy,trayt,'LineWidth',4,'Color', [0.2, 0.7, 0.1]);
xlabel('Eje X (m)','FontSize', 18);
ylabel('Eje Y (m)','FontSize', 18);
zlabel('Tiempo (s)','FontSize', 18);
set(gca, 'FontSize', 18);  % Tamaño de los números en los ejes
set(gca, 'XScale', 'linear', 'YScale', 'linear', 'ZScale', 'linear');  % Escala lineal en los ejes X, Y, Z
legend('RMD1','RMD2','RMD3','RMD4','RMD5','RMD6','Trayectoria','Location', 'northwest')
